...
document.querySelector('.js-reset-score-button')
  .addEventListener('click', () => renderResetConfirmation());
...
function renderResetConfirmation() {
  const divElement = document.querySelector('.js-reset-confirmation');
  ...
  `
    <p>
      ...
      <button class="js-deny-reset-button">No</button>
    </p>
  `;
  ...
  document.querySelector('.js-deny-reset-button')
    .addEventListener('click', () => divElement.innerHTML = '');
}
